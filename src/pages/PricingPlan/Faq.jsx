  ...
  return (
    <div>
      <div className="container mx-auto flex flex-col justify-center p-4 md:p-8">
        <p className=" p-2 text-center text-sm font-medium uppercase">
          How it works
        </p>
        <h2 className=" mb-2 text-center text-3xl font-bold md:text-5xl">
        ...
        <div className="md:flex">
          <div className="flex flex-col divide-y divide-gray-700 sm:pl-8  ">
            <details>
